  ...
  return (
    <div className="superadmin-dashboard">
      ...
      <div className="dashboard-actions">
        <button onClick={() => window.location.href = '/superadmin/create-college'}>Create College</button>
        <button onClick={() => window.location.href = '/superadmin/create-admin'}>Create Admin</button>
      </div>
